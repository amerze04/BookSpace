...
import { BookableInterval } from '../models/availability.models';
import { utcToResourceLocal } from '../date/local-date';
...
function fakeSegment(overrides: Partial<import('../grid/availability-grid').DaySegment> = {}) {
  return {
    date: '2026-09-21',
    startMinutes: 9 * 60,
    endMinutes: 11 * 60,
