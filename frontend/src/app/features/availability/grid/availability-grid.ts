import { BookableInterval, LocalDateString } from '../models/availability.models';
import { addDays, addMinutesToUtc, localDateDiffDays, utcToResourceLocal, weekdayOf } from '../date/local-date';
