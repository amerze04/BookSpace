...
namespace BookSpace.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260915080436_AlterApproveBookingProcedureLocksResourceAndApprover")]
    partial class AlterApproveBookingProcedureLocksResourceAndApprover
    {
        /// <inheritdoc />
                    ...
                    b.ToTable("Resources", null, t =>
                        {
                            ...
                            t.HasCheckConstraint("CK_Resources_ResourceType", "[ResourceType] IN ('Room', 'Equipment', 'Vehicle', 'LabSlot', 'Other')");
                        });
                });
