...
public sealed class ArchiveResourceCommandRequestHandler
    : IRequestHandler<ArchiveResourceCommandRequest, ArchiveResourceCommandResponse>
{
    private readonly IResourceRepository _resources;
    private readonly ICurrentUser _currentUser;
    private readonly IClock _clock;

    public ArchiveResourceCommandRequestHandler(
    ...
    public async Task<ArchiveResourceCommandResponse> Handle(
        ArchiveResourceCommandRequest request,
        CancellationToken cancellationToken)
    {
        ...
        // (UpdateResourceCommandRequestHandler), because that genuinely asks for
        ...
        {
            return resource.ToArchiveResponse();
        }
