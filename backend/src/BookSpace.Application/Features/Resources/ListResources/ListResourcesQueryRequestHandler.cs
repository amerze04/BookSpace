...
public sealed class ListResourcesQueryRequestHandler
    : IRequestHandler<ListResourcesQueryRequest, PagedResult<ListResourcesQueryResponse>>
{
    private readonly IResourceRepository _resources;

    public ListResourcesQueryRequestHandler(IResourceRepository resources)
    {
        _resources = resources;
    }

    public Task<PagedResult<ListResourcesQueryResponse>> Handle(
        ListResourcesQueryRequest request,
