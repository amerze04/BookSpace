...
public sealed class UpdateResourceCommandRequestHandler
    : IRequestHandler<UpdateResourceCommandRequest, UpdateResourceCommandResponse>
{
    ...
    public UpdateResourceCommandRequestHandler(
    ...
    public async Task<UpdateResourceCommandResponse> Handle(
        UpdateResourceCommandRequest request,
        CancellationToken cancellationToken)
    {
        ...
        return resource.ToUpdateResponse(timeZoneChange);
    }
}
