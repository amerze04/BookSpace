...
public sealed class RefreshTokenCommandRequestHandler : IRequestHandler<RefreshTokenCommandRequest, RefreshTokenCommandResponse>
{
    ...
    private readonly ILogger<RefreshTokenCommandRequestHandler> _logger;

    public RefreshTokenCommandRequestHandler(
        IAuthenticationUserRepository users,
        IRefreshTokenRepository refreshTokens,
        IRefreshTokenFactory refreshTokenFactory,
        TokenIssuer tokenIssuer,
        IClock clock,
        ILogger<RefreshTokenCommandRequestHandler> logger)
    {
        _users = users;
    ...
    public async Task<RefreshTokenCommandResponse> Handle(RefreshTokenCommandRequest request, CancellationToken cancellationToken)
    {
        ...
        var (tokens, issued) = _tokenIssuer.Issue(
            found.User,
        ...
        // Mapped rather than returned straight through — see
        // RefreshTokenCommandResponse; the RefreshToken here is the rotated one.
        return new RefreshTokenCommandResponse(tokens.AccessToken, tokens.ExpiresIn, tokens.RefreshToken);
    }
}
